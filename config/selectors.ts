/**
 * CSS selectors and menu/page structure for E2E tests.
 * Product test data (PRODUCT_SPECS) used by U004 and related specs.
 */
...
/** Reusable product specifications for tests (e.g. U004). */
