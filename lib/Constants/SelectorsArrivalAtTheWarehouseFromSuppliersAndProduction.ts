export const SELECTOR_ARRIVAL_AT_THE_WAREHOUSE_FROM_SUPPLIERS_AND_PRODUCTION =
...
export const MODAL_WINDOW_TABLE =
  'table[data-testid="ComingToSclad-ModalComing-ModalAddNewWaybill-Main-TableWrapper-ContrastBlock-Table"]';
export const MODAL_WINDOW_TABLE_ID =
  'ComingToSclad-ModalComing-ModalAddNewWaybill-Main-TableWrapper-ContrastBlock-Table';
export const MODAL_WINDOW_TABLE_QUANTITY_COLUMN_ID =
  '.table-th.coming-table__th.coming-table__th_count-parish';
export const MODAL_WINDOW_TABLE_CHECKBOX_COLUMN_ID =
  '.table-th.coming-table__th.coming-table__th_checkbox';

export const BUTTON_CREATE_INCOME =
  '.button-yui-kit.small.primary-yui-kit.coming-to-sclad__button';
export const BUTTON_CREATE_CLASS =
  '.button-yui-kit.small.primary-yui-kit.coming-to-sclad__button';
export const BUTTON_ADD_TO_RECEIPT =
  '.button-yui-kit.small.primary-yui-kit.modal-add-new-waybill__button';
...
export const BUTTON_KITS_LIST_SAVE =
  '[data-testid="ComingToSclad-ModalComing-ModalAddNewWaybill-KitsList-Buttons-Save"]';

// Modal selectors
export const MODAL_MAIN =
  '[data-testid="ComingToSclad-ModalComing-ModalAddNewWaybill"]';
export const MODAL_KITS_LIST =
  '[data-testid="ComingToSclad-ModalComing-ModalAddNewWaybill-KitsList"]';
export const MODAL_KITS_LIST_TABLE =
  '[data-testid="ComingToSclad-ModalComing-ModalAddNewWaybill-KitsList-Main-Table"]';
...
// Other tables
export const TABLE_MODAL_COMING_SCROLL =
