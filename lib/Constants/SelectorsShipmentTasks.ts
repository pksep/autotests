...
export const ROW_NUMBER_PATTERN = '[data-testid^="IssueToPull-ShipmentsTableBlock-ShippingTasks-ShipmentsTable-Tbody-Number"]';
export const ROW_ORDER_NUMBER_PATTERN = '[data-testid^="IssueToPull-ShipmentsTableBlock-ShippingTasks-ShipmentsTable-Tbody-NumberOrder"]';
