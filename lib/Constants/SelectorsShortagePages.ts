...
export const TABLE_DEFICIT_IZD_TABLE = '[data-testid="DeficitCbed-Section-Table"]';
export const TABLE_DEFICIT_IZD_TABLE_TBODY = '[data-testid="DeficitCbed-Section-Table-Tbody"]';
