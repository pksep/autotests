...
Generated: 2026-07-02T21:39:26.399Z

Server routes: 450
Covered routes: 450
Uncovered routes: 0
Coverage: 100.0%
Detected autotest calls: 467
...
| covered | DELETE | `api/buyer/:param` | `src/modules/buyer/buyer.controller.ts#banBuyer` | api/buyer/:param (pages/API/APIBuyer.ts) |
| covered | DELETE | `api/cbed/:param` | `src/modules/cbed/cbed.controller.ts#banCbed` | api/cbed/:param (pages/API/APICBED.ts) |
| covered | DELETE | `api/comments/:param` | `src/modules/thread/thread.controller.ts#deleteCommentById` | api/comments/:param (pages/API/APIComments.ts) |
...
| covered | DELETE | `api/equipment/file/:param` | `src/modules/equipment/equipment.controller.ts#removeFileEquipment` | api/equipment/file/:param (pages/API/APIEquipment.ts) |
...
| covered | DELETE | `api/exclusion/:param` | `src/modules/exclusion/exclusion.controller.ts#bunExclusionById` | api/exclusion/:param (pages/API/APIExclusion.ts) |
...
| covered | DELETE | `api/rack/:param` | `src/modules/rack/rack.controller.ts#banRack` | api/rack/:param (pages/API/APIRack.ts) |
| covered | DELETE | `api/rack/delete/cell` | `src/modules/rack/rack.controller.ts#deleteDataByIds` | api/rack/delete/cell (pages/API/APIRack.ts) |
...
| covered | DELETE | `api/settings/db/:param` | `src/modules/settings/settings.controller.ts#dropDumpDB` | api/settings/db/:param (pages/API/APISettings.ts) |
...
| covered | GET | `api/buyer/by_id/:param` | `src/modules/buyer/buyer.controller.ts#getById` | api/buyer/by_id/:param (pages/API/APIBuyer.ts) |
| covered | GET | `api/buyer/files/:param/:param` | `src/modules/buyer/buyer.controller.ts#attachFileToBuyer` | api/buyer/files/:param/:param (pages/API/APIBuyer.ts) |
| covered | GET | `api/buyer/light/:param` | `src/modules/buyer/buyer.controller.ts#getBuyers` | api/buyer/light/:param (pages/API/APIBuyer.ts) |
...
| covered | GET | `api/cbed/drafts/:param` | `src/modules/cbed/cbed.controller.ts#openDrafts` | api/cbed/drafts/:param (pages/API/APICBED.ts) |
...
| covered | GET | `api/cbed/relatives/production/task/:param` | `src/modules/cbed/cbed.controller.ts#getRelativesProductionTask` | api/cbed/relatives/production/task/:param (pages/API/APICBED.ts) |
...
| covered | GET | `api/comments/by-entity/:param/:param` | `src/modules/thread/thread.controller.ts#getListCommentEntity` | api/comments/by-entity/:param/:param (pages/API/APIComments.ts) |
| covered | GET | `api/comments/by-thread/:param` | `src/modules/thread/thread.controller.ts#getThreadById` | api/comments/by-thread/:param (pages/API/APIComments.ts) |
...
| covered | GET | `api/detal/relatives/production/task/:param` | `src/modules/detal/detal.controller.ts#getRelativesProductionTask` | api/detal/relatives/production/task/:param (pages/API/APIDetails.ts) |
...
| covered | GET | `api/exclusion/:param` | `src/modules/exclusion/exclusion.controller.ts#getExclusionById` | api/exclusion/:param (pages/API/APIExclusion.ts) |
...
| covered | GET | `api/neo4j/stairs/:param/:param` | `src/modules/neo4j/neo4j.controller.ts#getRelativesStairs` | api/neo4j/stairs/:param/:param (pages/API/APINeo4j.ts) |
...
| covered | GET | `api/product/tech_by_id_product/:param` | `src/modules/product/product.controller.ts#getTechByProductId` | api/product/tech_by_id_product/:param (pages/API/APIProducts.ts) |
...
| covered | GET | `api/production-task/for-all-equipments` | `src/modules/production-tasks/production-tasks.controller.ts#getProductionTaskByAllEquipments` | api/production-task/for-all-equipments (pages/API/APIProductionTasks.ts) |
...
| covered | GET | `api/production-task/update-all-task-relative` | `src/modules/production-tasks/production-tasks.controller.ts#updateAllTaskRelative` | api/production-task/update-all-task-relative (pages/API/APIProductionTasks.ts) |
| covered | GET | `api/provider` | `src/modules/provider/provider.controller.ts#getProviders` | api/provider (pages/API/APIProvider.ts) |
| covered | GET | `api/provider/:param` | `src/modules/provider/provider.controller.ts#getOneProvider` | api/provider/:param (pages/API/APIProvider.ts) |
| covered | GET | `api/provider/ban/:param` | `src/modules/provider/provider.controller.ts#banProviders` | api/provider/ban/:param (pages/API/APIProvider.ts) |
| covered | GET | `api/provider/files/:param/:param` | `src/modules/provider/provider.controller.ts#attachFileToProvider` | api/provider/files/:param/:param (pages/API/APIProvider.ts) |
| covered | GET | `api/rack/:param` | `src/modules/rack/rack.controller.ts#getOneRack` | api/rack/:param (pages/API/APIRack.ts) |
...
| covered | GET | `api/settings/db` | `src/modules/settings/settings.controller.ts#getAllDB` | api/settings/db (pages/API/APISettings.ts) |
| covered | GET | `api/settings/db/download/:param` | `src/modules/settings/settings.controller.ts#downloadDb` | api/settings/db/download/:param (pages/API/APISettings.ts) |
| covered | GET | `api/settings/db/new` | `src/modules/settings/settings.controller.ts#newDB` | api/settings/db/new (pages/API/APISettings.ts) |
| covered | GET | `api/settings/edizm` | `src/modules/settings/settings.controller.ts#getAllEdizm` | api/settings/edizm (pages/API/APISettings.ts) |
| covered | GET | `api/settings/inaction` | `src/modules/settings/settings.controller.ts#inactionGet` | api/settings/inaction (pages/API/APISettings.ts) |
| covered | GET | `api/settings/norm-hours` | `src/modules/settings/settings.controller.ts#getNormHours` | api/settings/norm-hours (pages/API/APISettings.ts) |
| covered | GET | `api/settings/typeedizm` | `src/modules/settings/settings.controller.ts#getAllTypeEdizm` | api/settings/typeedizm (pages/API/APISettings.ts) |
...
| covered | GET | `api/solidworks/get-entity/:param/:param` | `src/modules/solidworks/solidworks.controller.ts#findEntityBySolidworkType` | api/solidworks/get-entity/:param/:param (pages/API/APISolidworks.ts) |
...
| covered | GET | `api/supply/new-number-order` | `src/modules/supply/supply.controller.ts#getNewNumberOrder` | api/supply/new-number-order (pages/API/APISupply.ts) |
...
| covered | GET | `api/users/get/table/config/:param` | `src/modules/users/users.controller.ts#getTableConfigByUserId` | api/users/get/table/config/:param (pages/API/APIUsers.ts) |
...
| covered | POST | `api/buyer` | `src/modules/buyer/buyer.controller.ts#createBuyer` | api/buyer (pages/API/APIBuyer.ts) |
| covered | POST | `api/buyer/archive` | `src/modules/buyer/buyer.controller.ts#getBuyersArchive` | api/buyer/archive (pages/API/APIBuyer.ts) |
| covered | POST | `api/buyer/getinclude/:param` | `src/modules/buyer/buyer.controller.ts#getInclude` | api/buyer/getinclude/:param (pages/API/APIBuyer.ts) |
| covered | POST | `api/buyer/name/check` | `src/modules/buyer/buyer.controller.ts#checkNameExisting` | api/buyer/name/check (pages/API/APIBuyer.ts) |
| covered | POST | `api/buyer/pagination` | `src/modules/buyer/buyer.controller.ts#getBuyersPagination` | api/buyer/pagination (pages/API/APIBuyer.ts) |
| covered | POST | `api/buyer/update` | `src/modules/buyer/buyer.controller.ts#updateBuyer` | api/buyer/update (pages/API/APIBuyer.ts) |
...
| covered | POST | `api/comments/create` | `src/modules/thread/thread.controller.ts#addCommentEntity` | api/comments/create (pages/API/APIComments.ts) |
...
| covered | POST | `api/exclusion` | `src/modules/exclusion/exclusion.controller.ts#createExclusion` | api/exclusion (pages/API/APIExclusion.ts) |
| covered | POST | `api/exclusion/pagination` | `src/modules/exclusion/exclusion.controller.ts#getExclusionPagination` | api/exclusion/pagination (pages/API/APIExclusion.ts) |
| covered | POST | `api/expenditure` | `src/modules/expenditure/expenditure.controller.ts#getExpenditure` | api/expenditure (pages/API/APIExpenditure.ts) |
...
| covered | POST | `api/product/deficits` | `src/modules/product/product.controller.ts#getAllDeficitProduct` | api/product/deficits (pages/API/APIProducts.ts) |
...
| covered | POST | `api/provider` | `src/modules/provider/provider.controller.ts#createProvider` | api/provider (pages/API/APIProvider.ts) |
| covered | POST | `api/provider/archive` | `src/modules/provider/provider.controller.ts#getAllArchive` | api/provider/archive (pages/API/APIProvider.ts) |
| covered | POST | `api/provider/name/check` | `src/modules/provider/provider.controller.ts#checkNameExisting` | api/provider/name/check (pages/API/APIProvider.ts) |
| covered | POST | `api/provider/pagination` | `src/modules/provider/provider.controller.ts#getBuyersPagination` | api/provider/pagination (pages/API/APIProvider.ts) |
| covered | POST | `api/rack` | `src/modules/rack/rack.controller.ts#createRack` | api/rack (pages/API/APIRack.ts) |
| covered | POST | `api/rack/pagination` | `src/modules/rack/rack.controller.ts#getAllRacks` | api/rack/pagination (pages/API/APIRack.ts) |
...
| covered | POST | `api/settings/edizm` | `src/modules/settings/settings.controller.ts#crateEdizm` | api/settings/edizm (pages/API/APISettings.ts) |
| covered | POST | `api/settings/edizm/update` | `src/modules/settings/settings.controller.ts#updateEdizm` | api/settings/edizm/update (pages/API/APISettings.ts) |
| covered | POST | `api/settings/norm-hours` | `src/modules/settings/settings.controller.ts#updateNormHours` | api/settings/norm-hours (pages/API/APISettings.ts) |
| covered | POST | `api/settings/typeedizm` | `src/modules/settings/settings.controller.ts#createTypeEdizm` | api/settings/typeedizm (pages/API/APISettings.ts) |
...
| covered | POST | `api/shipments/shcheckupdate` | `src/modules/shipments/shipments.controller.ts#shComplitUpdate` | api/shipments/shcheckupdate (pages/API/APIShipments.ts) |
...
| covered | POST | `api/solidworks/create-entity` | `src/modules/solidworks/solidworks.controller.ts#UseInterceptors` | api/solidworks/create-entity (pages/API/APISolidworks.ts) |
...
| covered | POST | `api/users` | `src/modules/users/users.controller.ts#UseInterceptors` | api/users (pages/API/APIUsers.ts) |
| covered | POST | `api/users/archive` | `src/modules/users/users.controller.ts#archive` | api/users/archive (pages/API/APIUsers.ts) |
...
| covered | POST | `api/users/role` | `src/modules/users/users.controller.ts#addRole` | api/users/role (pages/API/APIUsers.ts) |
| covered | POST | `api/users/role/:param/:param` | `src/modules/users/users.controller.ts#changeRoleById` | api/users/role/:param/:param (pages/API/APIUsers.ts) |
| covered | POST | `api/users/set/table/config` | `src/modules/users/users.controller.ts#updateTableConfig` | api/users/set/table/config (pages/API/APIUsers.ts) |
...
| covered | POST | `api/users/update` | `src/modules/users/users.controller.ts#UseInterceptors` | api/users/update (pages/API/APIUsers.ts) |
...
| covered | PUT | `api/cbed/ava/update` | `src/modules/cbed/cbed.controller.ts#actualAvatar` | api/cbed/ava/update (pages/API/APICBED.ts) |
| covered | PUT | `api/comments/:param` | `src/modules/thread/thread.controller.ts#updateCommentEntity` | api/comments/:param (pages/API/APIComments.ts) |
| covered | PUT | `api/comments/:param/pin` | `src/modules/thread/thread.controller.ts#pinCommentById` | api/comments/:param/pin (pages/API/APIComments.ts) |
| covered | PUT | `api/comments/:param/unpin` | `src/modules/thread/thread.controller.ts#unpinCommentById` | api/comments/:param/unpin (pages/API/APIComments.ts) |
...
| covered | PUT | `api/exclusion/:param` | `src/modules/exclusion/exclusion.controller.ts#updateExclusion` | api/exclusion/:param (pages/API/APIExclusion.ts) |
...
| covered | PUT | `api/product/ava/update` | `src/modules/product/product.controller.ts#actualAvatar` | api/product/ava/update (pages/API/APIProducts.ts) |
...
| covered | PUT | `api/rack` | `src/modules/rack/rack.controller.ts#updateRack` | api/rack (pages/API/APIRack.ts) |
| covered | PUT | `api/rack/add/cell` | `src/modules/rack/rack.controller.ts#addDataToCell` | api/rack/add/cell (pages/API/APIRack.ts) |
| covered | PUT | `api/rack/update/cell` | `src/modules/rack/rack.controller.ts#updateCell` | api/rack/update/cell (pages/API/APIRack.ts) |
...
| covered | PUT | `api/settings/db/load/:param/:param` | `src/modules/settings/settings.controller.ts#loadDumpDb` | api/settings/db/load/:param/:param (pages/API/APISettings.ts) |
| covered | PUT | `api/settings/inaction/:param` | `src/modules/settings/settings.controller.ts#inactionChange` | api/settings/inaction/:param (pages/API/APISettings.ts) |
...
| covered | PUT | `api/shipments/status/ready-to-ship/:param` | `src/modules/shipments/shipments.controller.ts#updateReadyToShipStatus` | api/shipments/status/ready-to-ship/:param (pages/API/APIShipments.ts) |
| covered | PUT | `api/solidworks/update-entity` | `src/modules/solidworks/solidworks.controller.ts#UseInterceptors` | api/solidworks/update-entity (pages/API/APISolidworks.ts) |
