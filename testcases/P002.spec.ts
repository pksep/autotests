...
export const runP002 = () => {
  ...
  test('case 0: Дефицит Продукции (Product Deficit) Page - Scan tables within a specific element', async ({ page }) => {
  ...
  test.skip('Case 1 - Verify Дефицит Продукции (Product Deficit) Page Column Count and Order Check for RIGHT table', async ({ page }) => {
    ...
    await allure.step('Step 4: Count the number of columns in the table and their order', async () => {
      ...
      columnCount = await shortagePage.checkTableColumns(page, 'defizd_table');
  ...
  test.skip('Case 2 - Verify Дефицит Продукции (Product Deficit) Page Column Count and Order Check for LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Дефицит Продукции');
    allure.label('story', 'Verify Column count and order');
  ...
  test.skip('Case 3 - Verify Дефицит Продукции (Product Deficit) Page Column header values Check for RIGHT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Дефицит Продукции');
    ...
    await allure.step('Step 4: Check table column Header values', async () => {
      ...
      // Capture the number of columns from the checkTableColumns method
      const columnsVerified = await shortagePage.checkTableColumnHeaders(page, 'defizd_table', testData);
      expect(columnsVerified).toBe(true);
    });
  });

  test.skip('Case 4 - Verify Дефицит Продукции (Product Deficit) Page Column header values Check for LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Дефицит Продукции');
    allure.label('story', 'Verify Column header values check');
  ...
  test.skip('Case 5 - Verify Дефицит Продукции (Product Deficit) Page Row Ordering for RIGHT table', async ({ page }) => {
    test.setTimeout(600000);
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Дефицит Продукции');
  ...
  test.skip('Case 6 - Verify Дефицит Продукции (Product Deficit) Page Row Ordering for LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Дефицит Продукции');
    allure.label('story', 'Verify row sort ordering');
  ...
  test.skip('Case 7 - Verify Дефицит Продукции (Product Deficit) Page search functionality LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Дефицит Продукции');
    allure.label('story', 'Verify row sort ordering');
  ...
  test.skip('Case 8 - Verify Дефицит Продукции (Product Deficit) Page search functionality RIGHT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Дефицит Продукции');
    allure.label('story', 'Verify row sort ordering');
  ...
  test.skip('Case 9 - Verify Дефицит Продукции (Product Deficit) Page - Compare dates with Order List for RIGHT table', async ({ page }) => {
    test.setTimeout(600000);
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
