...
export const runTasksAPI = () => {
    ...
    test("Tasks API - Security & Authentication Tests", async ({ request, page }) => {
        ...
        await test.step("Test 1: Create task without authentication", async () => {
            console.log("Testing unauthenticated task creation...");
            ...
            console.log("✅ Unauthenticated task creation correctly rejected with 401");
        });
    ...
    test("Tasks API - Performance & Concurrency Tests", async ({ request, page }) => {
        ...
        await test.step("Test 6: Response time performance for create task", async () => {
            console.log("Testing create task response time performance...");
            ...
            console.log(`✅ Create task response time: ${responseTime}ms (acceptable)`);
        });

        await test.step("Test 7: Test concurrent task creation attempts", async () => {
            console.log("Testing concurrent task creation attempts...");
            ...
            console.log("✅ Concurrent task creation attempts handled successfully");
        });
    });
};
