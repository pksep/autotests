...
import testData from '../testdata/CPTP18-T2.json'; // Import your test data
import testData2 from '../testdata/CPTP18-T1.json'; // Import your test data

const WAREHOUSE_PAGE_BUTTON = "Sclad-completionProductPlan";
...
const RIGHT_DATA_TABLE_ORDERS_ICON_COL = "TableComplect-TableComplect-NameColumn";
const RIGHT_DATA_TABLE_CELL_X = "TableComplect-TableComplect-TableRow-";
...
export const runP009 = () => {
    logger.info(`Starting test: Verify Комплектация Изделий на план (Completing Products to Plan) Page Functionality`);
    ;

    // Use a separate step to initialize the shortagePage
    test.beforeEach(async ({ page }) => {
        const shortagePage = new CreateCompletingProductsToPlanPage(page);
        ...
        await allure.step('Step 3: Find and click the Комплектация Изделий на план (Completing Products to Plan) button', async () => {
    ...
    test('Test Case 0: Комплектация Изделий на план (Completing Products to Plan) Page - Scan tables within a specific element', async ({ page }) => {
        test.setTimeout(600000);
        allure.label('severity', 'normal');
        allure.label('epic', 'Склад');
        allure.label('feature', 'Комплектация Изделий на план (Completing Products to Plan)');
        allure.label('story', 'Verify Table Structures');
        allure.description('Комплектация Изделий на план (Completing Products to Plan) Page - Scan tables within a specific element.');
        await allure.step('Test Case 0: Комплектация Изделий на план (Completing Products to Plan) Page - Scan tables within a specific element', async () => {
            const shortagePage = new CreateCompletingProductsToPlanPage(page);
            ...
            const result1 = await shortagePage.scanTablesWithinElement(page, 'ModalOperationPath-destroyModalRight');
            page.mouse.click(1, 1);
            await shortagePage.findAndClickElement(page, "TableComplect-TableComplect-RowDeficitsCell", 3000);
            await shortagePage.findAndClickElement(page, "ModalDeepDeficitForObject-CBSRows-OperationsCell", 3000);

            const result2 = await shortagePage.scanTablesWithinElement(page, 'TableComplect-TableComplect-ModalDeficitForObject');
            page.mouse.click(1, 1);
            page.mouse.click(1, 1);
    ...
    test('Test Case 1 - Verify Комплектация Изделий на план (Completing Products to Plan) Page Column Count and Order Check for RIGHT table', async ({ page }) => {
        ...
        allure.description('Verify Комплектация Изделий на план (Completing Products to Plan) Page Column Count and Order Check for RIGHT table.');
    ...
    test('Test Case 2 - Verify Комплектация Изделий на план (Completing Products to Plan) Page Column Count and Order Check for LEFT table', async ({ page }) => {
        allure.label('severity', 'normal');
        allure.label('epic', 'Склад');
        allure.label('feature', 'Комплектация Изделий на план (Completing Products to Plan)');
        allure.label('story', 'Verify Column count and order');
        allure.description('Verify Комплектация Изделий на план (Completing Products to Plan) Page Column Count and Order Check for LEFT table.');
        const shortagePage = new CreateCompletingProductsToPlanPage(page);
    ...
    test('Test Case 3 - VerifyКомплектация Изделий на план (Completing Products to Plan) Page Column header values Check for RIGHT table', async ({ page }) => {
        allure.label('severity', 'normal');
        allure.label('epic', 'Склад');
        allure.label('feature', 'Комплектация Изделий на план (Completing Products to Plan)');
        allure.label('story', 'Verify Column header values check');
        allure.description('Verify Комплектация Изделий на план (Completing Products to Plan) Page Column header values Check for RIGHT table.');
    ...
    test('Test Case 4 - Verify Комплектация Изделий на план (Completing Products to Plan) Page Column header values Check for LEFT table', async ({ page }) => {
        allure.label('severity', 'normal');
        allure.label('epic', 'Склад');
        allure.label('feature', 'Комплектация Изделий на план (Completing Products to Plan)');
        allure.label('story', 'Verify Column header values check');
        allure.description('Verify Комплектация Изделий на план (Completing Products to Plan) Page Column header values Check for LEFT table.');
        const shortagePage = new CreateCompletingProductsToPlanPage(page);
    ...
    test('Test Case 5 - Verify Комплектация Изделий на план (Completing Products to Plan) Page Row Ordering for RIGHT table', async ({ page }) => {
        test.setTimeout(600000);
        allure.label('severity', 'normal');
        allure.label('epic', 'Склад');
        allure.label('feature', 'Комплектация Изделий на план (Completing Products to Plan)');
        allure.label('story', 'Verify row sort ordering');
        allure.description('Verify Комплектация Изделий на план (Completing Products to Plan) Page Row Ordering for RIGHT table.');
        const shortagePage = new CreateCompletingProductsToPlanPage(page);
    ...
    test('Test Case 6 - Verify Комплектация Изделий на план (Completing Products to Plan) Page Row Ordering for LEFT table', async ({ page }) => {
        allure.label('severity', 'normal');
        allure.label('epic', 'Склад');
        allure.label('feature', 'Комплектация Изделий на план (Completing Products to Plan)');
        allure.label('story', 'Verify row sort ordering');
        allure.description('Verify Комплектация Изделий на план (Completing Products to Plan) Page Row Ordering for LEFT table.');
        const shortagePage = new CreateCompletingProductsToPlanPage(page);
    ...
    test('Test Case 7 - Verify Комплектация Изделий на план (Completing Products to Plan) Page search functionality LEFT table', async ({ page }) => {
        allure.label('severity', 'normal');
        allure.label('epic', 'Склад');
        allure.label('feature', 'Комплектация Изделий на план (Completing Products to Plan)');
        allure.label('story', 'Verify row sort ordering');
        allure.description('VerifyКомплектация Изделий на план (Completing Products to Plan) Page search functionality for LEFT table.');
        const shortagePage = new CreateCompletingProductsToPlanPage(page);
    ...
    test('Test Case 8 - Verify Комплектация Изделий на план (Completing Products to Plan) Page search functionality RIGHT table', async ({ page }) => {
        allure.label('severity', 'normal');
        allure.label('epic', 'Склад');
        allure.label('feature', 'Комплектация Изделий на план (Completing Products to Plan)');
        allure.label('story', 'Verify row sort ordering');
        allure.description('Verify Комплектация Изделий на план (Completing Products to Plan) Page search functionality for LEFT table.');
        test.setTimeout(600000);
        const shortagePage = new CreateCompletingProductsToPlanPage(page);
        let searchQuery = 'Обозначение';
    ...
    test('Test Case 9 - Комплектация Изделий на план (Completing Products to Plan) Page - Compare dates with Order List for RIGHT table', async ({ page }) => {
        test.setTimeout(600000);
        allure.label('severity', 'normal');
        allure.label('epic', 'Склад');
        allure.label('feature', 'Комплектация Изделий на план (Completing Products to Plan)');
        allure.label('story', 'Verify row sort ordering');
        allure.description('Verify Комплектация Изделий на план (Completing Products to Plan) Page Dates in main table match dates in the Orders List for RIGHT table.');
        const shortagePage = new CreateCompletingProductsToPlanPage(page);
