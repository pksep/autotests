...
export const runP010 = () => {
  ...
  test('Case 0: База деталей Page - Scan tables within a specific element', async ({ page }) => {
  ...
  test('Case 1 - Verify База деталей (Parts Database) Page Column Count and Order Check for LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'База деталей');
    allure.label('feature', 'База деталей');
  ...
  test('Case 2 - Verify База деталей (Parts Database) Page Column Count and Order Check for CENTER table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'База деталей');
    allure.label('feature', 'База деталей');
    allure.label('story', 'Verify Column count and order');
  ...
  test('Case 3 - Verify База деталей (Parts Database) Page Column Count and Order Check for RIGHT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'База деталей');
  ...
  test('Case 4 - Verify База деталей (Parts Database) Page Column header values Check for LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'База деталей');
    allure.label('feature', 'База деталей');
  ...
  test('Case 5 - Verify База деталей (Parts Database) Page Column header values Check for CENTER table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'База деталей');
    allure.label('feature', 'База деталей');
    allure.label('story', 'Verify Column header values check');
  ...
  test('Case 6 - Verify База деталей (Parts Database) Page Column header values Check for RIGHT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'База деталей');
    allure.label('feature', 'База деталей');
    allure.label('story', 'Verify Column header values check');
  ...
  test.skip('Case 9 - Verify Сборка Склад (Assembly Warehouse) Page search functionality LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
  ...
  test.skip('Case 10 - Verify Сборка Склад (Assembly Warehouse) Page search functionality RIGHT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Заказ склада на Сборку');
    allure.label('story', 'Verify row sort ordering');
  ...
  test.skip('Case 11 - Verify Сборка Склад (Assembly Warehouse) Page - Compare dates with Order List for RIGHT table', async ({ page }) => {
    test.setTimeout(600000);
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Заказ склада на Сборку');
