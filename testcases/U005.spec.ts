        ...
        await allure.step("Step 16: Click the Загрузить все файлы button and confirm modal closure", async () => {
            ...
            while (retryCounter <= maxRetries) {
                ...
                if (notification?.message === "Файл с таким именем уже существует") {
                    ...
                    const sectionsCount = await page.locator(`[data-testid="${CONST.ADD_DETAIL_FILE_COMPONENT_DRAG_AND_DROP_MODAL_ADD_FILE_INPUT_FILE_NAME_INPUT}"]`).count();
                    ...
                    for (let i = 0; i < sectionsCount; i++) {
                        ...
                        const fileInput = page.locator(`[data-testid="${CONST.ADD_DETAIL_FILE_COMPONENT_DRAG_AND_DROP_MODAL_ADD_FILE_INPUT_FILE_NAME_INPUT}"]`).nth(i);
