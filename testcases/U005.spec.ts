...
const ADD_DETAIL_FILE_COMPONENT_MODAL_BASE_FILES_FILE_WINDOW_FILE_TABLE_SEARCH_DROPDOWN_INPUT = 'Search-Dropdown-Input';
const ADD_DETAIL_FILE_COMPONENT_MODAL_BASE_FILES_FILE_WINDOW_FILE_TABLE_TABLE = 'AddDetal-FileComponent-ModalBaseFiles-FileWindow-Table-Table';
...
const ADD_DETAIL_FILE_COMPONENT_MODAL_BASE_FILES_FILE_WINDOW_FILE_TABLE_TABLE_THEAD = 'AddDetal-FileComponent-ModalBaseFiles-FileWindow-Table-Table-Thead';
...
const ADD_DETAIL_FILE_COMPONENT_DRAG_AND_DROP_MODAL_ADD_FILE_TEXTAREA_DESCRIPTION_TEXTAREA =
...
const ADD_DETAIL_FILE_COMPONENT_DRAG_AND_DROP_MODAL_ADD_FILE_INPUT_NUMBER_VERSION_INPUT =
...
export const runU005 = () => {
  ...
  test('TestCase 02 - создат дитайл', async ({ browser, page }) => {
    ...
    await allure.step('Step 20: Add the file to the attach list in bottom table (Verify that search works for each column)', async () => {
      ...
      const isButtonReady = await shortagePage.isButtonVisibleTestId(
        page,
        ADD_DETAIL_FILE_COMPONENT_MODAL_BASE_FILES_FILE_WINDOW_ADD_BUTTON,
        'Добавить',
        false,
        ADD_DETAIL_FILE_COMPONENT_MODAL_BASE_FILES,
      );
