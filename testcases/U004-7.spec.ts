...
let tableData_original_15: { groupName: string; items: string[][] }[] = [];
...
export const runU004_7 = () => {
  ...
  test('TestCase 14 - Сохранить без добавления каких-либо элементов в спецификацию и проверка сохранения (Save Without Adding Material)', async ({ page }, testInfo) => {
  ...
  test('TestCase 15 - Перезагрузить без сохранения после добавления деталей в спецификацию и проверка (Reload without saving)', async ({ page }, testInfo) => {
