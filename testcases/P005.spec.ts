...
export const runP005 = () => {
  ...
  test('case 0: Металлообработка склад (Metalworking Warehouse) Page - Scan tables within a specific element', async ({ page }) => {
    ...
    const combinedErrors = [...result1.errors, ...result2.errors, ...result3.errors];
  ...
  test.skip('Case 1 - Verify Металлообработка склад (Metalworking Warehouse) Page Column Count and Order Check for RIGHT table', async ({ page }) => {
  ...
  test.skip('Case 2 - Verify Металлообработка склад (Metalworking Warehouse) Page Column Count and Order Check for LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
  ...
  test.skip('Case 3 - Verify Металлообработка склад (Metalworking Warehouse) Page Column header values Check for RIGHT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Металлообработка склад');
  ...
  test.skip('Case 4 - Verify Металлообработка склад (Metalworking Warehouse) Page Column header values Check for LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Металлообработка склад');
    allure.label('story', 'Verify Column header values check');
  ...
  test.skip('Case 5 - Verify Металлообработка склад (Metalworking Warehouse) Page Row Ordering for RIGHT table', async ({ page }) => {
    test.setTimeout(600000);
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Металлообработка склад');
  ...
  test.skip('Case 6 - Verify Металлообработка склад (Metalworking Warehouse) Page Row Ordering for LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Металлообработка склад');
    allure.label('story', 'Verify row sort ordering');
  ...
  test.skip('Case 7 - Verify Металлообработка склад (Metalworking Warehouse) Page search functionality LEFT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Металлообработка склад');
    allure.label('story', 'Verify row sort ordering');
  ...
  test.skip('Case 8 - Verify Металлообработка склад (Metalworking Warehouse) Page search functionality RIGHT table', async ({ page }) => {
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Металлообработка склад');
    allure.label('story', 'Verify row sort ordering');
  ...
  test.skip('Case 9 - Verify Металлообработка склад (Metalworking Warehouse) Page - Compare dates with Order List for RIGHT table', async ({ page }) => {
    test.setTimeout(600000);
    allure.label('severity', 'normal');
    allure.label('epic', 'Склад');
    allure.label('feature', 'Металлообработка склад');
    ...
    await allure.step('Step 4: compare the dates in each Row, with thier Orders list', async () => {
      ...
      if (nameColId !== -1 && urgencyColId !== -1 && plannedShipmentColId !== -1 && ordersColId !== -1) {
        ...
        const sortedCorrect = await shortagePage.checkDatesWithOrderList(
          page,
          RIGHT_DATA_TABLE,
          nameColId,
          urgencyColId,
