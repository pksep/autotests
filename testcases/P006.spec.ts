...
import testData from '../testdata/ST18-T2.json'; // Import your test data
import testData2 from '../testdata/ST18-T1.json'; // Import your test data
import testData3 from '../testdata/ST18-T3.json'; // Import your test data

const WAREHOUSE_PAGE_BUTTON = "Sclad-residuals-residuals";
...
const LEFT_DATA_TABLE = "OstatkiPCBDTable-Table";
...
const CENTER_DATA_TABLE = "OstatkiPCBDTable-Table";

const RIGHT_DATA_TABLE = "OstatkiPCBDTable-Table";
...
export const runP006 = () => {
    ...
    test.beforeEach(async ({ page }) => {
        const shortagePage = new CreateStockPage(page);
    ...
    test.skip('Test Case 2 - Verify Сборка Склад (Assembly Warehouse) Page Column Count and Order Check for CENTER table', async ({ page }) => {
