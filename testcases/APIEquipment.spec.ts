...
import { APIEquipment } from "../pages/APIEquipment";
...
export const runEquipmentAPI = () => {
    ...
    test("Equipment API - Security & Authentication Tests", async ({ request, page }) => {
        ...
        await test.step("Test 1: Create equipment without authentication", async () => {
            ...
            console.log("✅ Unauthenticated equipment creation correctly rejected with 401");
        });
    ...
    test("Equipment API - Performance & Concurrency Tests", async ({ request, page }) => {
        ...
        await test.step("Test 6: Response time performance for create equipment", async () => {
            console.log("Testing create equipment response time performance...");
            ...
            console.log(`✅ Create equipment response time: ${responseTime}ms (acceptable)`);
        });

        await test.step("Test 7: Test concurrent equipment operations", async () => {
            console.log("Testing concurrent equipment operations...");
            ...
            const promises = Array(5).fill(null).map(() =>
                equipmentAPI.createEquipmentType(request, equipmentData, API_CONST.API_TEST_USER_ID)
            );
            ...
            console.log("✅ Concurrent equipment operations handled successfully");
        });
    });
};
