...
const orderedQuantity: number = 2; // Declare outside to share between steps
const orderedQuantity2: number = 666; // Declare outside to share between steps
let targetRow: any = null; // Declare outside to share between steps
const specificationQuantity: number = 1; // Global variable for specification quantity from step 10
const waybillCollections: number = 0; // Global variable to track waybill collections
  ...
  test('TestCase 03 - ERP-969 - Big urgent test for details & specifications', async ({ page }) => {
    ...
    await allure.step("Step 2: Verify 'cbed' table is visible", async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(cbedTable).toBeVisible();
        },
        'Verify cbed table is visible',
        test.info(),
      );
    });
    ...
    await allure.step("Step 3: Search in 'cbed' table", async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(cbedInput).toBeVisible();
        },
        'Verify cbed input is visible',
        test.info(),
      );
      await cbedInput.fill(TEST_DATA.NEW_SB_A);
      await cbedInput.press('Enter');
      await page.waitForTimeout(TIMEOUTS.STANDARD); // Allow search results to update.
    });
    ...
    await allure.step("Step 4: Verify no results in 'cbed' table", async () => {
      ...
      await expectSoftWithScreenshot(
        ...
        'Verify no results in cbed table',
        test.info(),
      );
    });
    ...
    await allure.step("Step 5: Verify 'detal' table is visible", async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(detalTable).toBeVisible();
        },
        'Verify detal table is visible',
        test.info(),
      );
    });
    ...
    await allure.step("Step 6: Search in 'detal' table", async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(detalInput).toBeVisible();
        },
        'Verify detal input is visible',
        test.info(),
      );
    ...
    await allure.step("Step 7: Verify no results in 'detal' table", async () => {
      ...
      await expectSoftWithScreenshot(
        ...
        'Verify no results in detal table',
        test.info(),
      );
    });
    ...
    await allure.step(`Step 9: Verify detail "${TEST_DATA.NEW_DETAIL_A}" was saved`, async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(detailSearchInput).toBeVisible();
        },
    ...
    await allure.step(`Step 10: Add specification with detail "${TEST_DATA.NEW_SB_A}" for type СБ`, async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(smallDialogDetailInput).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
        'Verify small dialog detail input is visible',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(dialogTable).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
        },
        'Verify dialog table is visible',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(dialogSearchInput).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
        },
        'Verify dialog search input is visible',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(specsTable).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        () => {
          expect.soft(detailAdded).toBe(true);
        },
        'Verify detail was added to specs',
        test.info(),
      );

      // Finally, click save on the product page and verify the success message.
      const save = page.locator(SelectorsPartsDataBase.CREATOR_BUTTON_SAVE);
    ...
    await allure.step('Step 11.2: Click the Ревизия button', async () => {
      ...
      await skladPage.waitForTimeout(TIMEOUTS.MEDIUM);
    });
    ...
    await allure.step('Step 11.4: Find the search input and search for the detail', async () => {
      ...
      await searchInput.press('Enter');
      await skladPage.waitForLoadState('networkidle');
      await skladPage.waitForTimeout(TIMEOUTS.STANDARD);
    });
    ...
    await allure.step('Step 11.5: Verify exactly one matching row is found', async () => {
      ...
      await expectSoftWithScreenshot(
        ...
        'Verify exactly one matching row from search',
        test.info(),
      );
    });
    ...
    await allure.step("Step 11.6: Update the actual quantity to '1' in the editable cell", async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(row).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(fourthCell).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(editField).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
    ...
    await allure.step('Step 11.7: Confirm the update in the confirmation dialog', async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(confirmButton).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
    ...
    await allure.step('Step 11.8: Reload, open Детайли, search again, and verify updated quantity', async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(skladTable).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
        'Verify sklad table is visible',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        ...
        'Verify one row in updated table',
        test.info(),
      );
      ...
      await skladPage.waitForTimeout(TIMEOUTS.EXTENDED);
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(editDiv).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
        'Verify edit div is visible',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        page,
        () => {
          expect.soft(value.trim()).toBe('1');
        },
        'Verify saved value after reload',
        test.info(),
      );
    });
    await allure.step('Step 12: Open residuals in new tab and verify saved detail has 0 quantity', async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(residualsTable).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
        'Verify residuals table is visible',
        test.info(),
      );
      ...
      await searchInput.fill('');
      await searchInput.press('Enter');
      await residualsPage.waitForTimeout(TIMEOUTS.STANDARD);
      ...
      await expectSoftWithScreenshot(
        ...
        'Verify one row in residuals table',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        page,
        () => {
          expect.soft(cellText.trim()).toBe('0');
        },
        'Verify residual quantity is 0',
        test.info(),
      );
      await residualsPage.waitForTimeout(TIMEOUTS.EXTENDED);
    });
    ...
    await allure.step('Step 13: Create supplier order and start production for test SB', async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(supplierModal).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      const productionTable = orderAssembly.locator(SelectorsOrderedFromSuppliers.TABLE_MODAL_ADD_ORDER_PRODUCTION_TABLE);
      await detailsPage.highlightElement(productionTable);
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(productionTable).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(bottomTable).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(bottomRows.first()).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
        },
        'Verify bottom rows first is visible',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(modalTitle).toContainText('Создание заказа на сборку', { timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(modalTitle).toContainText(today, { timeout: WAIT_TIMEOUTS.SHORT });
        },
        'Verify modal title contains today date',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(orderButton).toBeEnabled({ timeout: WAIT_TIMEOUTS.LONG });
        },
      ...
      const smallModalDialog = page.locator(SelectorsOrderedFromSuppliers.MODAL_ADD_ORDER_SMALL_DIALOG_OPEN);
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(orderButton).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
        },
      ...
      if (!isButtonEnabled) {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(orderButton).toBeEnabled({ timeout: WAIT_TIMEOUTS.STANDARD });
          },
          'Verify order button is enabled',
          test.info(),
        );
    ...
    await allure.step('Step 14: Search for the created order in the order table', async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(orderTable).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
    ...
    await allure.step('Step 15: Click the found order row and verify order details in modal', async () => {
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(dateCell).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(orderModal).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(modalTitle).toContainText('Заказ', { timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(modalDateElement).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(modalOrderNumberElement).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(table).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        async () => {
          await expect.soft(firstDataRow).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
        },
      ...
      await expectSoftWithScreenshot(
        page,
        () => {
          expect.soft(thirdColumnText?.trim()).toBe(TEST_DATA.NEW_SB_A);
        },
        'Verify third column contains NEW_SB_A',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        page,
        () => {
          expect.soft(completedColumnText?.trim()).toBe('0');
        },
        'Verify completed column is 0',
        test.info(),
      );
      ...
      await expectSoftWithScreenshot(
        page,
        () => {
          expect.soft(parseInt(orderedColumnValue?.trim() || '0')).toBe(orderedQuantity);
        },
        'Verify ordered column value matches orderedQuantity',
        test.info(),
      );
      await warehousePage.waitForTimeout(TIMEOUTS.VERY_LONG);
      // Close the modal
    ...
    await allure.step('Step 16: Navigate to assembly kitting page and search for our SB', async () => {
      ...
      await allure.step('Sub-step 16.3: Verify page title', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(pageTitle).toHaveText('Комплектация сборок на план', { timeout: WAIT_TIMEOUTS.SHORT });
          },
          'Verify page title has expected text',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.4: Locate and verify kitting table', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(kittingTable).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
          },
      ...
      await allure.step('Sub-step 16.6: Verify search result in first row', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(columnText?.trim()).toBe(TEST_DATA.NEW_SB_A);
          },
          'Verify column 3 contains NEW_SB_A',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.7: Double click third column to open modal', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(waybillModal).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
          },
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(innerContent).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
          },
          'Verify inner content is visible',
          test.info(),
        );
      ...
      await allure.step("Sub-step 16.9: Verify modal title contains today's date", async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(modalTitle).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
          },
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(titleText).toContain('Накладная на комплектацию Сборки');
          },
          'Verify modal title contains expected text',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.10: Verify collected quantity is 0', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(collectedQuantityValue?.trim() || '0')).toBe(0);
          },
      ...
      await allure.step('Sub-step 16.11: Verify required quantity matches order quantity', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(requiredQuantity?.trim() || '0')).toBe(orderedQuantity);
          },
          'Verify required quantity matches order quantity',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.12: Verify own quantity input has order quantity', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(ownQuantityValue?.trim() || '0')).toBe(orderedQuantity);
          },
          'Verify own quantity matches ordered quantity',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.13: Verify assembly name in waybill modal', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(sbName?.trim()).toBe(TEST_DATA.NEW_SB_A);
          },
      ...
      await allure.step('Sub-step 16.14: Verify total quantity label', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(totalQuantityText?.trim()).toBe(expectedText);
          },
          'Verify total quantity text matches expected',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.15: Verify shipment details section', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(shipmentDetailsTable).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
          },
          'Verify shipment details table is visible',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.16: Verify order number in shipment details', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(orderNumberFound).toBe(true);
          },
      ...
      await allure.step('Sub-step 16.17: Verify remaining quantity in shipment details', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(remainingQuantity?.trim() || '0')).toBe(orderedQuantity);
          },
          'Verify remaining quantity matches ordered quantity',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.18: Verify detail name in details table', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(detailName?.trim()).toBe(TEST_DATA.NEW_DETAIL_A);
          },
          'Verify detail name matches',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.19: Verify quantity per unit', async () => {
        ...
        const quantityPerUnitCell = kittingPage.locator(`[data-testid="${SelectorsModalWaybill.DETAILS_TABLE_ROW_PREFIX}${rowId}${SelectorsModalWaybill.DETAILS_TABLE_ROW_QUANTITY_CELL_SUFFIX}"]`);
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(quantityPerUnit?.trim() || '0')).toBe(specificationQuantity);
          },
          'Verify quantity per unit matches specification quantity',
          test.info(),
        );
      ...
      await allure.step("Sub-step 16.20: Verify material cell shows 'Нет материала'", async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(materialText?.trim()).toBe('Нет материала');
          },
          'Verify material text is Нет материала',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.21: Verify need cell calculation', async () => {
        needCell = kittingPage.locator(`[data-testid="${SelectorsModalWaybill.DETAILS_TABLE_ROW_PREFIX}${rowId}${SelectorsModalWaybill.DETAILS_TABLE_ROW_NEED_CELL_SUFFIX}"]`);
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(needQuantity?.trim() || '0')).toBe(orderedQuantity * specificationQuantity);
          },
          'Verify need quantity calculation',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.22: Verify free quantity cell', async () => {
        const freeQuantityCell = kittingPage.locator(`[data-testid="${SelectorsModalWaybill.DETAILS_TABLE_ROW_PREFIX}${rowId}${SelectorsModalWaybill.DETAILS_TABLE_ROW_FREE_QUANTITY_CELL_SUFFIX}"]`);
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(freeQuantity?.trim() || '0')).toBe(expectedFreeQuantity);
          },
          'Verify free quantity matches expected',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.23: Verify quantity cell', async () => {
        const quantityCell = kittingPage.locator(`[data-testid="${SelectorsModalWaybill.DETAILS_TABLE_ROW_PREFIX}${rowId}${SelectorsModalWaybill.DETAILS_TABLE_ROW_QUANTITY_CELL_SUFFIX}"]`);
      ...
      await allure.step('Sub-step 16.24: Verify in kits cell', async () => {
        const inKitsCell = kittingPage.locator(`[data-testid="${SelectorsModalWaybill.DETAILS_TABLE_ROW_PREFIX}${rowId}${SelectorsModalWaybill.DETAILS_TABLE_ROW_IN_KITS_CELL_SUFFIX}"]`);
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(inKitsValue?.trim() || '0')).toBe(0);
          },
      ...
      await allure.step('Sub-step 16.25: Verify deficit cell calculation', async () => {
        ...
        freeQuantityCellForDeficit = kittingPage.locator(`[data-testid="${SelectorsModalWaybill.DETAILS_TABLE_ROW_PREFIX}${rowId}${SelectorsModalWaybill.DETAILS_TABLE_ROW_FREE_QUANTITY_CELL_SUFFIX}"]`);
        needCellForDeficit = kittingPage.locator(`[data-testid="${SelectorsModalWaybill.DETAILS_TABLE_ROW_PREFIX}${rowId}${SelectorsModalWaybill.DETAILS_TABLE_ROW_NEED_CELL_SUFFIX}"]`);
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(deficitValue?.trim() || '0')).toBe(expectedDeficit);
          },
      ...
      await allure.step('Sub-step 16.27: Change own quantity input to build quantity', async () => {
        ...
        await kittingPage.waitForLoadState('networkidle');
        await kittingPage.waitForTimeout(TIMEOUTS.STANDARD);
        await detailsPage.highlightElement(ownQuantityInput, HIGHLIGHT.HIGHLIGHT_SUCCESS);
      });
      ...
      await allure.step('Sub-step 16.28: Verify updated need cell', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(updatedNeedQuantity?.trim() || '0')).toBe(currentBuildQuantity * specificationQuantity);
          },
          'Verify updated need quantity calculation',
          test.info(),
        );
        await detailsPage.highlightElement(needCell, HIGHLIGHT.HIGHLIGHT_SUCCESS);
      });
      ...
      await allure.step('Sub-step 16.29: Verify updated deficit cell', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(parseInt(updatedDeficitValue?.trim() || '0')).toBe(updatedExpectedDeficit);
          },
          'Verify updated deficit value matches expected',
          test.info(),
        );
        await detailsPage.highlightElement(deficitCell, HIGHLIGHT.HIGHLIGHT_SUCCESS);
      });
      ...
      await allure.step('Sub-step 16.30: Verify complete set button is now visible', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(completeSetButton).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
          },
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(completeSetButton).toBeEnabled({ timeout: WAIT_TIMEOUTS.SHORT });
          },
      ...
      await allure.step('Sub-step 16.31: Verify warning message is no longer present', async () => {
        if (warningMessage) {
          await expectSoftWithScreenshot(
            page,
            async () => {
              await expect.soft(warningMessage).not.toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
            },
            'Verify warning message is not visible',
            test.info(),
          );
        }
        await kittingPage.waitForTimeout(TIMEOUTS.VERY_LONG);
      });
      ...
      await allure.step('Sub-step 16.33: Verify order selection warning appears', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(selectOrderWarning).toBeVisible({ timeout: WAIT_TIMEOUTS.SHORT });
          },
          'Verify select order warning is visible',
          test.info(),
        );
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(selectOrderText).toContain('Выберите заказ');
          },
          'Verify select order warning text',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.37: Refresh page and search for SB again after completion', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(kittingTable2).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
          },
          'Verify kitting table 2 is visible',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.38: Get the first row after search', async () => {
        ...
        await expectSoftWithScreenshot(
          page,
          async () => {
            await expect.soft(kittingTable3).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
          },
          'Verify kitting table 3 is visible',
          test.info(),
        );
      ...
      await allure.step('Sub-step 16.39: Verify updated name cell', async () => {
        await kittingPage.waitForTimeout(TIMEOUTS.STANDARD);
        const rowNameCell = firstRow3.locator(`[data-testid^="${SelectorsERP969.TABLE_COMPLECT_TABLE_ROW_CELL}"][data-testid$="${SelectorsERP969.TABLE_COMPLECT_TABLE_ROW_CELL_NAME}"]`);
        ...
        await expectSoftWithScreenshot(
          page,
          () => {
            expect.soft(rowName?.trim()).toBe(TEST_DATA.NEW_SB_A);
          },
          'Verify row name matches',
          test.info(),
        );
        ...
        await allure.step('Sub-step 16.40: Verify updated ordered quantity', async () => {
          ...
          const orderedCell = firstRow3.locator(`[data-testid^="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL}"][data-testid$="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL_ORDERED}"]`);

          // Wait for the element to be visible and attached before highlighting
          await expectSoftWithScreenshot(
            page,
            async () => {
              await expect.soft(orderedCell).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
            },
            'Verify ordered cell is visible',
            test.info(),
          );
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(orderedValue?.trim()).toBe(orderedQuantity.toString());
            },
            'Verify ordered value matches',
            test.info(),
          );
        ...
        await allure.step('Sub-step 16.41: Verify updated operations cell', async () => {
          const operationsCell = firstRow3.locator(`[data-testid^="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL}"][data-testid$="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL_OPERATIONS}"]`);
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(operationsValue?.trim()).toBe(specificationQuantity.toString());
            },
            'Verify operations value matches',
            test.info(),
          );
        ...
        await allure.step('Sub-step 16.42: Verify updated status cell', async () => {
          ...
          const statusCell = firstRow3.locator(`[data-testid^="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL}"][data-testid$="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL_STATUS}"]`);
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(statusValue?.trim()).toBe(`${expectedCompletionPercentage}%`);
            },
        ...
        await allure.step('Sub-step 16.43: Verify updated completion level cell', async () => {
          const completionLevelCell = firstRow3.locator(`[data-testid^="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL}"][data-testid$="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL_COMPLETION_LEVEL_NEW}"]`);
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(completionLevelValue?.trim()).toBe(`${expectedCompletionPercentage}%`);
            },
            'Verify completion level matches',
            test.info(),
          );
        ...
        await allure.step('Sub-step 17.5: Double click on the designation column to open modal', async () => {
          const designationCell = firstRow.locator(`[data-testid^="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL}"][data-testid$="${SelectorsERP969.TABLE_KITTING_TABLE_ROW_CELL_DESIGNATION}"]`);
        ...
        await allure.step('Sub-step 17.6: Wait for modal to appear and validate details', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            async () => {
              await expect.soft(modalTitle).toBeVisible({ timeout: WAIT_TIMEOUTS.STANDARD });
            },
            'Verify modal title is visible',
            test.info(),
          );
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(titleText?.trim()).toContain('Накладная на комплектацию Сборки');
            },
            'Verify modal title contains expected text',
            test.info(),
          );
        ...
        await allure.step('Sub-step 17.7: Validate collected quantity cell', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(parseInt(collectedQuantityValue?.trim() || '0')).toBe(currentBuildQuantity);
            },
            'Verify collected quantity matches current build quantity',
            test.info(),
          );
        });
        ...
        await allure.step('Sub-step 17.8: Validate required quantity cell', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(parseInt(requiredQuantityValue?.trim() || '0')).toBe(orderedQuantity);
            },
            'Verify required quantity matches ordered quantity',
            test.info(),
          );
          await detailsPage.highlightElement(requiredQuantityCell, HIGHLIGHT.HIGHLIGHT_SUCCESS);
        });
        ...
        await allure.step('Sub-step 17.9: Validate own quantity input', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(parseInt(ownQuantityValue?.trim() || '0')).toBe(orderedQuantity - currentBuildQuantity);
            },
            'Verify own quantity calculation',
            test.info(),
          );
          await detailsPage.highlightElement(ownQuantityInput, HIGHLIGHT.HIGHLIGHT_SUCCESS);
        ...
        await allure.step('Sub-step 17.10: Validate name cell', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(waybillNameValue?.trim()).toBe(TEST_DATA.NEW_SB_A);
            },
            'Verify waybill name matches',
            test.info(),
          );
        ...
        await allure.step('Sub-step 17.11: Validate total quantity label', async () => {
          ...
          await expectSoftWithScreenshot(
            ...
            'Verify total quantity label is Всего: 0',
            test.info(),
          );
          await detailsPage.highlightElement(totalQuantityLabel, HIGHLIGHT.HIGHLIGHT_SUCCESS);
        });
        ...
        await allure.step('Sub-step 17.12: Validate order number cell', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(orderNumberValue?.trim()).toBe(`№${orderNumber}`);
            },
        ...
        await allure.step('Sub-step 17.13: Validate remaining quantity cell', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(parseInt(remainingQuantityValue?.trim() || '0')).toBe(orderedQuantity);
            },
            'Verify remaining quantity matches ordered quantity',
            test.info(),
          );
        ...
        await allure.step('Sub-step 17.14: Validate total left to do label', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(totalLeftToDoText?.trim()).toBe(`Всего: ${orderedQuantity}`);
            },
            'Verify total left to do text',
            test.info(),
          );
        ...
        await allure.step('Sub-step 17.15: Find the detail row by searching for the name cell with dynamic ID', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(detailNameValue?.trim()).toBe(TEST_DATA.NEW_DETAIL_A);
            },
            'Verify detail name matches',
            test.info(),
          );
        ...
        await allure.step('Sub-step 17.17: Validate need cell', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(parseInt(needValue?.trim() || '0')).toBe(currentBuildQuantity * specificationQuantity);
            },
            'Verify need value calculation',
            test.info(),
          );
          await detailsPage.highlightElement(needCell, HIGHLIGHT.HIGHLIGHT_SUCCESS);
        });
        ...
        await allure.step('Sub-step 17.19: Validate quantity per unit cell', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(parseInt(quantityPerUnitValue?.trim() || '0')).toBe(specificationQuantity);
            },
            'Verify quantity per unit matches specification quantity',
            test.info(),
          );
        ...
        await allure.step('Sub-step 17.20: Validate free quantity cell', async () => {
          ...
          await expectSoftWithScreenshot(
            page,
            () => {
              expect.soft(parseInt(freeQuantityValue?.trim() || '0')).toBe(expectedFreeQuantity);
            },
            'Verify free quantity matches expected',
            test.info(),
          );
