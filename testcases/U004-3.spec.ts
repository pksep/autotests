    ...
    test("TestCase 05 - Adding All Material Types at Once", async ({ page }) => {
        ...
        await allure.step("Step 001: Добавить СБ к товару (Add СБ to the product and save)", async () => {
            ...
            await allure.step("Step 08: Add and Validate Items in Specifications", async () => {
                const itemsToAdd = [
                    { smallDialogButtonId: CONST.MAIN_PAGE_SMALL_DIALOG_СБ, dialogTestId: CONST.EDIT_PAGE_ADD_СБ_RIGHT_DIALOG, searchTableTestId: CONST.MAIN_PAGE_СБ_TABLE, searchValue: CONST.TEST_PRODUCT_СБ, bottomTableTestId: CONST.EDIT_PAGE_ADD_СБ_RIGHT_DIALOG_BOTTOM_TABLE, addToBottomButtonTestId: CONST.EDIT_PAGE_ADD_СБ_RIGHT_DIALOG_ADDTOBOTTOM_BUTTON, addToMainButtonTestId: CONST.EDIT_PAGE_ADD_СБ_RIGHT_DIALOG_ADDTOMAIN_BUTTON, type: 'СБ' }
                ];
        ...
        await allure.step("Step 004: Добавить РМ к товару (Add РМ to the product and save)", async () => {
            await allure.step("Step 08: Add and Validate Items in Specifications", async () => {
                ...
                const itemsToAdd = [
                    { smallDialogButtonId: CONST.MAIN_PAGE_SMALL_DIALOG_РМ, dialogTestId: CONST.EDIT_PAGE_ADD_РМ_RIGHT_DIALOG, searchTableTestId: CONST.EDIT_PAGE_ADD_РМ_RIGHT_DIALOG_ITEM_TABLE, searchValue: CONST.TESTCASE_2_PRODUCT_РМ, bottomTableTestId: CONST.EDIT_PAGE_ADD_РМ_RIGHT_DIALOG_BOTTOM_TABLE, addToBottomButtonTestId: CONST.EDIT_PAGE_ADD_РМ_RIGHT_DIALOG_ADDTOBOTTOM_BUTTON, addToMainButtonTestId: CONST.EDIT_PAGE_ADD_РМ_RIGHT_DIALOG_ADDTOMAIN_BUTTON, type: 'РМ' }
