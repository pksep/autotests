...
export const runManufacturingAPI = () => {
    ...
    test("Manufacturing API - Security & Authentication Tests", async ({ request, page }) => {
        ...
        await test.step("Test 1: Create manufacturing order without authentication", async () => {
            console.log("Testing unauthenticated manufacturing order creation...");
            ...
            console.log("✅ Unauthenticated manufacturing order creation correctly rejected with 401");
        });
    ...
    test("Manufacturing API - Performance & Concurrency Tests", async ({ request, page }) => {
        ...
        await test.step("Test 6: Response time performance for create manufacturing order", async () => {
            console.log("Testing create manufacturing order response time performance...");
            ...
            console.log(`✅ Create manufacturing order response time: ${responseTime}ms (acceptable)`);
        });

        await test.step("Test 7: Test concurrent manufacturing operations", async () => {
            console.log("Testing concurrent manufacturing operations...");
            ...
            console.log("✅ Concurrent manufacturing operations handled successfully");
        });
    });
};
