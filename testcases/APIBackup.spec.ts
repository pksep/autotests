...
import { APIBackup } from "../pages/APIBackup";
...
export const runBackupAPI = () => {
    ...
    test("Backup API - Security & Authentication Tests", async ({ request, page }) => {
        ...
        await test.step("Test 1: Create backup without authentication", async () => {
            ...
            console.log("✅ Unauthenticated backup creation correctly rejected with 401");
        });
    ...
    test("Backup API - Performance & Concurrency Tests", async ({ request, page }) => {
        ...
        await test.step("Test 6: Response time performance for create backup", async () => {
            console.log("Testing create backup response time performance...");
            ...
            console.log(`✅ Create backup response time: ${responseTime}ms (acceptable)`);
        });

        await test.step("Test 7: Test concurrent backup creation attempts", async () => {
            console.log("Testing concurrent backup creation attempts...");
            ...
            const promises = Array(5).fill(null).map(() =>
                backupAPI.createBackup(request, backupData, API_CONST.API_TEST_USER_ID)
            );
            ...
            console.log("✅ Concurrent backup creation attempts handled successfully");
        });
    });
};
