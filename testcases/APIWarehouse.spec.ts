...
export const runWarehouseAPI = () => {
    ...
    test("Warehouse API - Security & Authentication Tests", async ({ request, page }) => {
        ...
        await test.step("Test 1: Create warehouse without authentication", async () => {
            console.log("Testing unauthenticated warehouse creation...");
            ...
            console.log("✅ Unauthenticated warehouse creation correctly rejected with 401");
        });
    ...
    test("Warehouse API - Performance & Concurrency Tests", async ({ request, page }) => {
        ...
        await test.step("Test 6: Response time performance for create warehouse", async () => {
            console.log("Testing create warehouse response time performance...");
            ...
            console.log(`✅ Create warehouse response time: ${responseTime}ms (acceptable)`);
        });

        await test.step("Test 7: Test concurrent warehouse operations", async () => {
            console.log("Testing concurrent warehouse operations...");
            ...
            console.log("✅ Concurrent warehouse operations handled successfully");
        });
    });
};
