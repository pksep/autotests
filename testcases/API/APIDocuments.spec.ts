...
export const runDocumentsAPI = () => {
  ...
  test('Documents API - Security & Authentication Tests', async ({ request, page }) => {
    ...
    await test.step('Test 1: Attach file without authentication', async () => {
      ...
      const unauthenticatedResponse = await documentsAPI.attachFileToUser(request, 1, 1, false, 'invalid_user');
    ...
    await test.step('Test 3: Change document type without authentication', async () => {
      ...
      const unauthenticatedResponse = await documentsAPI.changeDocumentType(request, { type: 'new_type' }, 'invalid_user');
  ...
  test('Documents API - Data Validation & Edge Cases', async ({ request, page }) => {
    ...
    await test.step('Test 4: Attach file with invalid user ID', async () => {
      ...
      const invalidUserResponse = await documentsAPI.attachFileToUser(request, API_CONST.API_TEST_EDGE_CASES.NEGATIVE_NUMBER, 1, false, API_CONST.API_TEST_USER_ID);
    ...
    await test.step('Test 5: Attach file with invalid file ID', async () => {
      ...
      const invalidFileResponse = await documentsAPI.attachFileToUser(request, 1, API_CONST.API_TEST_EDGE_CASES.NEGATIVE_NUMBER, false, API_CONST.API_TEST_USER_ID);
    ...
    await test.step('Test 6: Get file with invalid ID', async () => {
      ...
      const invalidIdResponse = await documentsAPI.getFileById(request, API_CONST.API_TEST_EDGE_CASES.NEGATIVE_NUMBER, true);
    ...
    await test.step('Test 8: Change document type with invalid ID', async () => {
      ...
      const invalidIdResponse = await documentsAPI.changeDocumentType(request, { id: API_CONST.API_TEST_EDGE_CASES.NEGATIVE_NUMBER, type: 'new_type' }, API_CONST.API_TEST_USER_ID);
    ...
    await test.step('Test 9: Change document type with empty type', async () => {
      ...
      const emptyTypeResponse = await documentsAPI.changeDocumentType(request, { id: 1, type: API_CONST.API_TEST_EDGE_CASES.EMPTY_STRING }, API_CONST.API_TEST_USER_ID);
    ...
    await test.step('Test 10: Change document type with XSS payload', async () => {
      ...
      const xssResponse = await documentsAPI.changeDocumentType(request, { id: 1, type: API_CONST.API_TEST_EDGE_CASES.XSS_PAYLOAD }, API_CONST.API_TEST_USER_ID);
  ...
  test('Documents API - File Operations & Data Integrity', async ({ request, page }) => {
    ...
    await test.step('Test 11: Test file operations with valid data', async () => {
      ...
      const attachResponse = await documentsAPI.attachFileToUser(request, parseInt(API_CONST.API_TEST_USER_TO_UPDATE_ID), parseInt(API_CONST.API_TEST_FILE_ID), false, API_CONST.API_TEST_USER_ID);
      ...
      const getFileResponse = await documentsAPI.getFileById(request, parseInt(API_CONST.API_TEST_DOCUMENT_ID), true);
      ...
      const changeTypeResponse = await documentsAPI.changeDocumentType(request, { id: parseInt(API_CONST.API_TEST_DOCUMENT_ID), type: API_CONST.API_TEST_DOCUMENT_TYPE_UPDATED }, API_CONST.API_TEST_USER_ID);
    ...
    await test.step('Test 12: Test file operations with boundary values', async () => {
      ...
      const maxIdResponse = await documentsAPI.getFileById(request, API_CONST.API_TEST_EDGE_CASES.MAX_INTEGER, true);
      ...
      const minIdResponse = await documentsAPI.getFileById(request, API_CONST.API_TEST_EDGE_CASES.MIN_INTEGER, true);
