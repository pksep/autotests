...
export const runCalendarAPI = () => {
    ...
    test("Calendar API - Security & Authentication Tests", async ({ request, page }) => {
        ...
        await test.step("Test 1: Create calendar event without authentication", async () => {
            console.log("Testing unauthenticated calendar event creation...");
            ...
            console.log("✅ Unauthenticated calendar event creation correctly rejected with 401");
        });
    ...
    test("Calendar API - Performance & Concurrency Tests", async ({ request, page }) => {
        ...
        await test.step("Test 6: Response time performance for create event", async () => {
            console.log("Testing create event response time performance...");
            ...
            console.log(`✅ Create event response time: ${responseTime}ms (acceptable)`);
        });

        await test.step("Test 7: Test concurrent event creation attempts", async () => {
            console.log("Testing concurrent event creation attempts...");
            ...
            console.log("✅ Concurrent event creation attempts handled successfully");
        });
    });
};
