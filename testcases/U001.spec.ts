...
export const runU001 = (isSingleTest: boolean, iterations: number) => {
    ...
    test.beforeEach("Test Case 00 - Authorization", async ({ page }) => {
        ...
        // await page.goto('/')
        // await page.waitForSelector('[data-testid="Authorization-Form-InputPassword"]')
        // await page.waitForSelector('[data-testid="Authorization-Form-ButtonLogin"]')
        // await page.waitForTimeout(500)
        // await page.locator('[data-testid="Authorization-Form-InputPassword"]').fill('54321')
        // await page.locator('[data-testid="Authorization-Form-ButtonLogin"]').click()
    });
    ...
    test("Test Case 18 - Checking new date by urgency", async ({ page }) => {
        ...
        const warehouseTableDateTestId = 'AssemblySclad-Table'
        const urgencyIDColumn = 'AssemblySclad-PrintTableHeader-UrgencyDateColumn'
        await allure.step("Step 1: Open the warehouse page", async () => {
            // Go to the Warehouse page
            await assemblyWarehouse.goto(
                SELECTORS.MAINMENU.WAREHOUSE.URL
            );
        });
            ...
            for (const cbed of descendantsCbedArray) {
                ...
                await allure.step(
                    ...
                    async () => {
                        ...
                        urgencyDateOnTable =
                            await assemblyWarehouse.getValueOrClickFromFirstRowNoThead(
                                warehouseTable,
                                numberColumn
                            );
    ...
    test("Test Case 31 - Check the order number", async ({ page }) => {
