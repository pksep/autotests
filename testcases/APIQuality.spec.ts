...
import { APIQuality } from "../pages/APIQuality";
...
export const runQualityAPI = () => {
    ...
    test("Quality API - Security & Authentication Tests", async ({ request, page }) => {
        ...
        await test.step("Test 1: Create quality check without authentication", async () => {
            ...
            console.log("✅ Unauthenticated quality check creation correctly rejected with 401");
        });
    ...
    test("Quality API - Performance & Concurrency Tests", async ({ request, page }) => {
        ...
        await test.step("Test 6: Response time performance for create quality check", async () => {
            console.log("Testing create quality check response time performance...");
            ...
            console.log(`✅ Create quality check response time: ${responseTime}ms (acceptable)`);
        });

        await test.step("Test 7: Test concurrent quality operations", async () => {
            console.log("Testing concurrent quality operations...");
            ...
            const promises = Array(5).fill(null).map(() =>
                qualityAPI.createQualityCheck(request, qualityData, API_CONST.API_TEST_USER_ID)
            );
            ...
            console.log("✅ Concurrent quality operations handled successfully");
        });
    });
};
