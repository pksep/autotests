...
export const runP004 = () => {
  logger.info(`Starting test P004`);
  ...
  test('TestCase 01 - Редактирование изделия - добавление потомка (СБ) (Editing a product - adding a descendant (СБ))', async ({ browser, page }) => {
    ...
    await allure.step('Step 15: Проверяем, что в инпуте наименования совпадает со значением переменной, по которой мы осуществляли поиск данного изделия (We check that the name in the input matches the value of the variable by which we searched for this product.)', async () => {
      ...
      const firstInputValue = inputFields.nth(0); //DATATESTID

      await expect(firstInputValue).toHaveValue(secondCellValue);
      logger.info(`Value in first input field: ${firstInputValue}`);

      // Get the value of the second input field
      const secondInputValue = inputFields.nth(1); //DATATESTID
      await expect(secondInputValue).toHaveValue(firstCellValue);
      logger.info(`Value in second input field: ${secondInputValue}`);
      // Get the value of the third input field

      const thirdInputValue = inputFields.nth(2); //DATATESTID
      await expect(thirdInputValue).toHaveValue(thirdCellValue);
    ...
    await allure.step('Step 24: Проверяем, что поиск во второй таблицы модального окна отображается. (Check that the search in the second table of the modal window is displayed.)', async () => {
      ...
      const isInputPresent = inputLocator;

      // Assert that the input is visible
      await expect(isInputPresent).toBeVisible();
    });
    ...
    await allure.step('Step 32: Убедитесь, что выбранная строка теперь отображается в нижней таблице.', async () => {
      ...
      const modal = page.locator(`dialog[data-testid^="${EDIT_PAGE_ADD_СБ_RIGHT_DIALOG}"]`);
  ...
  test('TestCase 02 - Очистка после теста. (Cleanup after test)', async ({ page }) => {
    ...
    await allure.step('Step 002: Очистка после теста. (Cleanup after test)', async () => {
      ...
      await allure.step('Step 002 sub step 4a: reset all items in the specifications (reset all items in the specifications)', async () => {
        const itemsToAdd = [
          {
            smallDialogButtonId: MAIN_PAGE_SMALL_DIALOG_СБ,
            dialogTestId: EDIT_PAGE_ADD_СБ_RIGHT_DIALOG,
            searchTableTestId: MAIN_PAGE_СБ_TABLE,
            searchValue: RESET_СБ_1,
            bottomTableTestId: EDIT_PAGE_ADD_СБ_RIGHT_DIALOG_BOTTOM_TABLE,
            addToBottomButtonTestId: EDIT_PAGE_ADD_СБ_RIGHT_DIALOG_ADDTOBOTTOM_BUTTON,
            addToMainButtonTestId: EDIT_PAGE_ADD_СБ_RIGHT_DIALOG_ADDTOMAIN_BUTTON,
            type: 'СБ',
          },
          {
            smallDialogButtonId: MAIN_PAGE_SMALL_DIALOG_СБ,
          ...
          {
            smallDialogButtonId: MAIN_PAGE_SMALL_DIALOG_Д,
            dialogTestId: EDIT_PAGE_ADD_Д_RIGHT_DIALOG,
            searchTableTestId: MAIN_PAGE_Д_TABLE,
            searchValue: RESET_Д_1,
            bottomTableTestId: EDIT_PAGE_ADD_Д_RIGHT_DIALOG_BOTTOM_TABLE,
            addToBottomButtonTestId: EDIT_PAGE_ADD_Д_RIGHT_DIALOG_ADDTOBOTTOM_BUTTON,
            addToMainButtonTestId: EDIT_PAGE_ADD_Д_RIGHT_DIALOG_ADDTOMAIN_BUTTON,
            type: 'Д',
          },
          {
            smallDialogButtonId: MAIN_PAGE_SMALL_DIALOG_ПД,
            dialogTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG,
            searchTableTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG_ITEM_TABLE,
            searchValue: RESET_ПД_1,
            bottomTableTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG_BOTTOM_TABLE,
            addToBottomButtonTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG_ADDTOBOTTOM_BUTTON,
            addToMainButtonTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG_ADDTOMAIN_BUTTON,
            type: 'ПД',
          },
          {
            smallDialogButtonId: MAIN_PAGE_SMALL_DIALOG_ПД,
        ...
        const itemsToAdd = [
          {
            ...
            dialogTestId: EDIT_PAGE_ADD_Д_RIGHT_DIALOG,
            searchTableTestId: MAIN_PAGE_Д_TABLE,
            searchValue: TESTCASE_2_PRODUCT_Д,
            bottomTableTestId: EDIT_PAGE_ADD_Д_RIGHT_DIALOG_BOTTOM_TABLE,
            addToBottomButtonTestId: EDIT_PAGE_ADD_Д_RIGHT_DIALOG_ADDTOBOTTOM_BUTTON,
            addToMainButtonTestId: EDIT_PAGE_ADD_Д_RIGHT_DIALOG_ADDTOMAIN_BUTTON,
            type: 'Д',
        ...
        const itemsToAdd = [
          {
            ...
            dialogTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG,
            searchTableTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG_ITEM_TABLE,
            searchValue: TESTCASE_2_PRODUCT_ПД,
            bottomTableTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG_BOTTOM_TABLE,
            addToBottomButtonTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG_ADDTOBOTTOM_BUTTON,
            addToMainButtonTestId: EDIT_PAGE_ADD_ПД_RIGHT_DIALOG_ADDTOMAIN_BUTTON,
            type: 'ПД',
        ...
        const itemsToAdd = [
          {
            ...
            bottomTableTestId: EDIT_PAGE_ADD_РМ_RIGHT_DIALOG_BOTTOM_TABLE,
            addToBottomButtonTestId: EDIT_PAGE_ADD_РМ_RIGHT_DIALOG_ADDTOBOTTOM_BUTTON,
            addToMainButtonTestId: EDIT_PAGE_ADD_РМ_RIGHT_DIALOG_ADDTOMAIN_BUTTON,
            type: 'РМ',
          },
        ];
  ...
  test('TestCase 04 - Очистка после теста. (Cleanup after test)', async ({ page }) => {
    ...
    await allure.step('Step 002: Очистка после теста. (Cleanup after test)', async () => {
      ...
      await allure.step('Step 002 sub step 3: Remove Д', async () => {
        ...
        for (const item of itemsToRemove) {
          const shortagePage = new CreatePartsDatabasePage(page);
          await shortagePage.removeItemFromSpecification(page, item.smallDialogButtonId, item.dialogTestId, item.bottomTableTestId, item.removeButtonColumnIndex, item.searchValue, item.returnButtonTestId, item.itemType);
        }
      });
  ...
  test('TestCase 07 - Редактирование изделия - Сравниваем комплектацию (Edit an Existing Детайл - Comparing the complete set)', async ({ page }) => {
    ...
    await allure.step('Step 13: Ensure the selected row is now showing in the bottom table', async () => {
      ...
      const modal = page.locator(`dialog[data-testid^="${EDIT_PAGE_ADD_Д_RIGHT_DIALOG}"]`);
  ...
  test('TestCase 09- Редактирование изделия - Сравниваем комплектацию (Edit an Existing Material ПД - Comparing the complete set)', async ({ page }) => {
    ...
    const dialog = page.locator(`dialog[data-testid="${EDIT_PAGE_ADD_ПД_RIGHT_DIALOG}"]`);
    ...
    await allure.step('Step 14: Ensure the selected row is now showing in the bottom table', async () => {
      ...
      // Locate the bottom table
      const modal = page.locator(`dialog[data-testid^="${EDIT_PAGE_ADD_ПД_RIGHT_DIALOG}"]`);
      ...
      for (let i = 0; i < rowCount; i++) {
        ...
        if (partName?.trim() === selectedPartNumber) {
          ...
          const assignmentCell = row.locator('td.table-yui-kit__td fieldset input.input-yui-kit__input[type="text"]');
  ...
  test('TestCase 11 - Delete a Material Before Saving', async ({ page }) => {
    ...
    const modal = page.locator(`[data-testid="${EDIT_PAGE_ADD_ПД_RIGHT_DIALOG}"]`);
  ...
  test('TestCase 12 - Удалить сохраненный материал (Remove Saved Material)', async ({ page }) => {
    ...
    const modal = page.locator(`[data-testid="${EDIT_PAGE_ADD_РМ_RIGHT_DIALOG}"]`);
    ...
    await allure.step('Step 14: Ensure the selected row is now showing in the bottom table', async () => {
      ...
      // Locate the bottom table
      const modal = page.locator(`dialog[data-testid^="${EDIT_PAGE_ADD_РМ_RIGHT_DIALOG}"]`);
  ...
  test('TestCase 13 - Добавить одинаковый СБ в спецификацию ДВА раза и проверка сохранения или нет (Add Duplicate Material Type)', async ({ page }) => {
    // skipped due to bug
  });
  ...
  test('TestCase 18 - Добавить, изменить и удалить несколько элементов одновременно в спецификацию и проверка сохранения (Add, Modify, and Delete in One Session)', async ({ page }) => {
    ...
    let modal = page.locator(`[data-testid="${EDIT_PAGE_ADD_ПД_RIGHT_DIALOG}"]`);
    table3Locator = modal.locator(`[data-testid="${EDIT_PAGE_ADD_ПД_RIGHT_DIALOG_ITEM_TABLE}"]`);
    ...
    modal = page.locator(`[data-testid="${EDIT_PAGE_ADD_РМ_RIGHT_DIALOG}"]`);
    table3Locator = modal.locator(`[data-testid="${EDIT_PAGE_ADD_РМ_RIGHT_DIALOG_ITEM_TABLE}"]`);
    ...
    await allure.step('Step 36: Проверяем, что в найденной строке таблицы содержится значение переменной (We check that the found table row contains the value of the variable)', async () => {
      ...
      const secondCell = table3Locator!.locator('tbody tr:first-child td:nth-child(1)');
      await secondCell.evaluate(row => {
        row.style.backgroundColor = 'yellow';
        row.style.border = '2px solid red';
        row.style.color = 'blue';
