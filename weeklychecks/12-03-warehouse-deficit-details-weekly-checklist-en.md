# Weekly Check: Warehouse Detail Deficit

## Scope

Page: **Дефицит деталей**

Route: `/sclad/deficitdetal`
...
| 2 | Check CNC Да/Нет values. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 3 | Verify deficit-with-production and incoming assembly/product columns. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 4 | Select rows and confirm action state changes safely. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
