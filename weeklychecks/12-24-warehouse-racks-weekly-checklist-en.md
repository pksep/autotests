...
| --- | --- | --- | --- | --- |
| 1 | Search by rack name. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 2 | Select a rack and verify edit/archive state. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 3 | Open create rack and close without saving. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 4 | Confirm rack list remains readable after refresh. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
