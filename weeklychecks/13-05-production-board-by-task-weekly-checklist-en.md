# Weekly Check: Production Board By Task

## Scope

Page: **Онлайн табло по ПЗ**

Route: `/production/board-production`
...
| --- | --- | --- | --- | --- |
| 1 | Check both task-board tabs, including Металлобработка as displayed. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 2 | Filter by PZ and confirm task number/date remain visible. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 3 | Compare ordered-by-PZ, all-PZ, and production quantities. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 4 | Search by designation/name and check print/history. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
