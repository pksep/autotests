# Weekly Check: Shipped Orders

## Scope

Page: **Отгруженные заказы**

Route: `/sclad/ordercomplit`
...
| --- | --- | --- | --- | --- |
| 1 | Search by order number or name. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 2 | Check date range. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 3 | Verify shipment number, buyer, order/date, article, and product columns. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
