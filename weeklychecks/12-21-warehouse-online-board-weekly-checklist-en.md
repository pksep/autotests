# Weekly Check: Warehouse Online Board

## Scope

Page: **Онлайн табло**

Route: `/sclad/online-board/`
...
| 2 | Filter by employee, operation, order, PZ, and date. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
