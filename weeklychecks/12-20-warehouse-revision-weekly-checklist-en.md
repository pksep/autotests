# Weekly Check: Warehouse Revision

## Scope

Page: **Ревизия на складе**

Route: `/sclad/revision/null/null`
...
| --- | --- | --- | --- | --- |
| 1 | Switch every inventory category tab. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 2 | Search by designation/article/name. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 3 | Check current vs factual quantity fields without pressing Enter on real stock changes. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 4 | Review change history table. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
