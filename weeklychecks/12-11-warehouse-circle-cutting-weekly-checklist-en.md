# Weekly Check: Circle/Profile Cutting

## Scope

Page: **Резка круга/профиля**

Route: `/sclad/cuttingcircle`
...
| 2 | Check round/profile blank dimensions. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 3 | Verify done/remaining quantities and status. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 4 | Check create-mark, export, and request actions safely. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
