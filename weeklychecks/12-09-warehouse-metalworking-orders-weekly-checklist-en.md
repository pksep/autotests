# Weekly Check: Warehouse Metalworking Orders

## Scope

Page: **Заказ склада на металлообработку**

Route: `/sclad/metalloworkingsclad`
...
| 2 | Filter by order and performer. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 3 | Check ordered, demand, deficit, quantity, operations, and readiness values. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 4 | Open details-by-operations and return. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
