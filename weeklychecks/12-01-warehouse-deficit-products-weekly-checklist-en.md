# Weekly Check: Warehouse Product Deficit

## Scope

Page: **Дефицит продукции**

Route: `/sclad/deficitizd`
...
| --- | --- | --- | --- | --- |
| 1 | Search by article or name. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 2 | Check negative deficit and demand values. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 3 | Select rows and verify own quantity input behavior. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
| 4 | Confirm launch-to-production is available only for valid selections. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
