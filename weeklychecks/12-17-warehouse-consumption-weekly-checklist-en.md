# Weekly Check: Warehouse Consumption

## Scope

Page: **Расход со склада**

Route: `/sclad/consumptionsclad`
...
| --- | --- | --- | --- | --- |
| 1 | Check date range and customer filter. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
...
| 3 | Verify invoice and order information areas. | Expected result matches the page purpose; data is readable and actions do not block the page. | Not run |  |
