...
import { runWorkResults } from './testcases/WorkResults.spec';
...
export const testSuites = {
    WorkResults: {
        description:
            "WorkResults test suite to verify functionalities specific to WorkResults.",
        tests: [
            {
                test: runWorkResults,
                description: "This test checks the WorkResults"
            }
        ]
    },
    ERP_969: {
